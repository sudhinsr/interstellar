...
<link href="css/bootstrap.min.css" rel="stylesheet">
  ...
  <head>
    <title>Interstellar|Updates</title>
...
function calcSpeed(prev, next) {
 ...
 <iframe id="player" name="youTube" type="text/html" width="750" height="450"  src=" http://www.youtube.com/embed/CwVYKGYjK9g?wmode=opaque&enablejsapi=1&autohide=1&showinfo=0 " frameborder="0" ></iframe>
...
<!-- </ul></div></div> -->
    ...
    $check = mysql_query("select * from leader where uid='$fid'");
